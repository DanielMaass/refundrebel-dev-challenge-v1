  ...
  return (
    <div className="container mx-auto space-y-12 py-16 p-4">
      <div className="text-center">
        <p className="gradient-text text-4xl md:text-6xl">
      ...
      <div className="flex gap-4 flex-wrap items-center justify-center">
        <SearchInput />
        <div className="grow flex gap-4 flex-nowrap items-center sm:max-w-60">
          <span>bis in</span>
          <DurationSelect />
        </div>
      </div>

      {isLoading && <p className="text-center">Verbindungen suchen...</p>}
